<script type="text/javascript" >
 ...
 <?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
        ...
        // Insert the submission date and time into the exam_attempt table
        $submissionDate = date("Y-m-d h:i:s");
        $insertSubmission = $conn->prepare("INSERT INTO exam_attempt (ex_id, submission_date) VALUES (?, ?)");
        $insertSubmission->execute([$examId, $submissionDate]);
    }
 ?>
